...
{
    /// <summary>
    /// The job of this class is to gather parts of a request - the url, any headers, and the content (payload) to create
    /// the appropriate request according to HTTP verb, what type of response is expected from the server, and whether a
    /// bearer token is required.
    /// 
    /// Courtesy: https://www.codeproject.com/Articles/1204494/Consuming-ASP-NET-Core-Web-API-using-HttpClient
    /// </summary>
