...
{
    /// <summary>
    /// This is the class that will actually build the appropriate request using the HttpRequestBuilder.
    /// 
    /// The job of this class is to get us the response message, not to pick at it. That will be the job
    /// of the implementer to extract the data it wants.
    /// </summary>
